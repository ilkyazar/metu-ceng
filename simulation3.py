...
#add shapes to board
board1.addShape(ball1.getShape(), ball1.getBody())
#board1.addShape(ball2.getShape(), ball2.getBody())
#board1.addShape(ball3.getShape(), ball3.getBody())
board1.addShape(block1.getShape(), block1.getBody())
board1.addShape(block2.getShape(), block2.getBody())
...
while s < board1.number_of_steps:
    ...
    board1.screen.fill(pygame.color.THECOLORS["white"])
    board1.screen.blit(user_txt, (5, board1.screen.get_height() - 20))
    board1.updateSpace()
