...
void TestableBoard::runInternal() {
    ...
    std::cout << currentGrade << " end phase 1 " << std::endl;
    ...
    std::cout << currentGrade << " end phase 2 " << std::endl;
    ...
    std::cout << currentGrade << " end phase 3 " << std::endl;
    ...
    if (attackCoord != tracer1->getCoord() || noopCoord != tracer1->getCoord())
        currentGrade -= 2;
    std::cout << currentGrade << " end phase 4 " << std::endl;
    ...
    std::cout << currentGrade << " end phase 5 " << std::endl;
    ...
    std::cout << currentGrade << " end " << std::endl;
