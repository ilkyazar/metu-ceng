...
public:
    ...
    std::vector<Player*>* sortPlayersByID();
    bool isGettingCloserToHill(Coordinate coord, Coordinate coordWithMove);
    Player* pickLowestID(std::vector<Player*> attackablePlayers);
